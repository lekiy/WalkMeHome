...
// import useGetDogSearch from './useGetDogsSearch';
...
function useGetDogs(filterBreeds: string[]): GetDogs<Dog[]> {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
            const searchRequest =  await fetch(baseUrl+'/search'+filterBreedsString, {
            method: 'GET',
          credentials: 'include',
          });
